...
function isAuthorizedRole($allowedRoles = [])
{
  $ci = get_instance();
  // Periksa apakah session role ada dan termasuk dalam daftar yang diizinkan
  if (in_array($ci->session->userdata('role'), $allowedRoles)) {
    return true;
  }

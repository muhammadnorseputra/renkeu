            ...
            <div class="x_content">
                ...
                <div class="row form-group">
                    ...
                    <select class="form-control" name="role" id="pilih-role" required data-parsley-trigger="change">
                        ...
                        <option value="ARSIP_USER" <?= ($is_role == 'ARSIP_USER') ? 'selected' : ''; ?>>ARSIP_USER</option>
                    </select>
                </div>
                <div class="row form-group">
                    ...
                    maxlength="13"
                    minlength="11" 
                    data-parsley-trigger="focusout" data-parsley-pattern-message="Nomor handphone tidak valid !" pattern="^(62)8[1-9][0-9]{6,9}$" data-parsley-maxlength="13" data-parsley-type="number" type="text" name="nohp" id="input-nohp" class="form-control" value="<?= $user->nohp ?>">
                </div>
                <div class="row form-group">

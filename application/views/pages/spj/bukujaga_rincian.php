<div class="x_panel">
    <div class="x_title">
        <h2><i class="fa fa-book mr-2"></i> Buku Jaga Rincian Belanja</h2>
    ...
    <div class="x_content">
        <div class="row">
            <div class="col-12 col-md-6">
                <?= form_open(base_url('app/bukujaga/view_rincian'), ['id' => 'formBukuJagaRincian', 'class' => 'form-horizontal form-label-left', 'data-parsley-validate' => '', 'data-parsley-errors-messages-disabled' => '']) ?>
                ...
                <input type="hidden" name="ref_uraian">
                <div class="form-group row">
                    <label for="koderek" class="row col-md-12">Kode Program/Kegiatan/Sub Kegiatan/Rekening <span class="text-danger ml-1 mr-1">*</span></label>
        ...
        <div class="modal-content rounded-0">
            ...
            <form class="form-horizontal" action="<?= base_url('app/bukujaga/carikode') ?>" method="post" id="formCariKode" data-parsley-validate>
                ...
                <div class="modal-header bg-success text-white rounded-0">
                    <h4 class="modal-title">Cari Kode Rekening</h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="rekening" id="rekening" class="select2_single form-control" required="required" data-parsley-errors-container="#help-block-rekening">
                            <option value="">Pilih Rekening</option>
                        </select>
                        <div id="help-block-rekening"></div>
                    </div>
                </div>
